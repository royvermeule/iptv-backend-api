...
class Profile
{
    ...
    #[ORM\Column(name: 'xtream_url', type: 'string', length: 500, nullable: true)]
    private ?string $xtreamUrl = null;

    #[ORM\Column(name: 'xtream_username', type: 'string', length: 500, nullable: true)]
    private ?string $xtreamUsername = null;

    #[ORM\Column(name: 'xtream_password', type: 'string', length: 500, nullable: true)]
